...
public class SystemUserRepository : ISystemUserRepository
{
    ...
    /// <inheritdoc />
    public async Task<(IEnumerable<SystemUser> users, int total)> GetPagedAsync(int page, int pageSize)
    {
        ...
        var total = await connection.QuerySingleAsync<int>(countSql);
        var users = await connection.QueryAsync<SystemUser>(dataSql, new { PageSize = pageSize, Offset = offset });
    ...
    {
        const string sql = "SELECT COUNT(*) FROM system_users WHERE email = @Email";
